...
glib_wrapper! {
    pub struct Text(Object<ibus_sys::IBusText, ibus_sys::IBusTextClass, TextClass>) @extends Serializable, Object, gobject::InitiallyUnowned;
...
impl Text {
    ...
    pub fn from_ucs4(str: char) -> Text {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(ibus_sys::ibus_text_new_from_ucs4(str.to_glib()))
        }
    }
...
pub trait TextExt: 'static {
    ...
    fn set_attributes<P: IsA<AttrList>>(&self, attrs: &P);
}
...
impl<O: IsA<Text>> TextExt for O {
    ...
    fn get_attributes(&self) -> Option<AttrList> {
        unsafe {
            from_glib_none(ibus_sys::ibus_text_get_attributes(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_attributes<P: IsA<AttrList>>(&self, attrs: &P) {
        unsafe {
            ibus_sys::ibus_text_set_attributes(self.as_ref().to_glib_none().0, attrs.as_ref().to_glib_none().0);
        }
    }
}
